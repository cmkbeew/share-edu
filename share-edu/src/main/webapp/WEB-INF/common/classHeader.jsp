...
<div class="d-flex border-bottom">
    ...
    <ul class="nav nav-pills rounded-pill align-items-center">
        ...
        <li class="nav-item">
            <a href="/myclass/shareList?member_idx=${sessionScope.member_idx}&type=send" class="nav-link rounded-pill note-link d-flex align-items-center px-2 px-md-3 mr-0 mr-md-2" id="note-business">
